    ...
    <animated.div className="bg-image" style={fadeIn}>
      ...
      <section className="text-gray-600 body-font">
        <div className=" mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="pl-12 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 mx-auto md:ml-4">
              Greetings! I&apos;m Krapansh,
              <br className="hidden lg:inline-block" />
              your go-to web developer.
            </h1>
            <p className="mb-8 leading-relaxed mx-auto md:ml-4">
